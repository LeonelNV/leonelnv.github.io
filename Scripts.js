...
function toggleLang() {
  ...
  const text = {
    es: {
      ...
      exp2: "<strong>Zen Interactive Labs</strong> | Junio de 2025 a febrero de 2026<br/>Desarrollo web frontend con Nuxt, Vue, JS, Tailwind, AWS, etc. y manejo de bases de datos.",
    ...
    en: {
      ...
      exp2: "<strong>Zen Interactive Labs</strong> | June 2025 to February 2026<br/>Frontend web development with Nuxt, Vue, JS, Tailwind, AWS, etc., and database management.",
      skillsTitle: "🚀 Skills",
